...
const GITHUB_USER = "savior00099";

const PINNED_REPOS = [
  {
    name: "todo-list-website",
    desc: "A clean, responsive to-do list web app for organizing daily tasks, built while learning core front-end fundamentals.",
    stars: 0,
    forks: 0,
    lang: "HTML",
  ...
  },
  {
    ...
    desc: "A creatively animated proposal-style website built to practice layout, styling, and interactive UI effects.",
    stars: 0,
    forks: 0,
    lang: "CSS",
    url: "https://github.com/savior00099"
  },
  {
    ...
    desc: "A front-end showcase experimenting with CSS/JS animations and transitions to build motion-design skills.",
    stars: 0,
    forks: 0,
    lang: "JavaScript",
    url: "https://github.com/savior00099"
